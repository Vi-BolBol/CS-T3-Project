  ...
  return (
    <div className="w-full max-w-4xl mx-auto rounded-2xl border border-white/5 bg-[#111B34]/40 p-6 sm:p-8 shadow-2xl backdrop-blur-md">
      ...
      <div className="mb-6">
        ...
        <p className="text-xs text-gray-400 mt-1">Set monthly pay range and internship duration.</p>
      </div>
            ...
            <div>
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-8 pr-4 py-3 rounded-xl border bg-[#070B19]/60 text-sm text-white placeholder-gray-600 focus:outline-none transition ${errClass('payMin')}`}
                />
              </div>
            ...
            <div>
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-8 pr-4 py-3 rounded-xl border bg-[#070B19]/60 text-sm text-white placeholder-gray-600 focus:outline-none transition ${errClass('payMax')}`}
                />
              </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <input
                ...
                placeholder="e.g. 3"
                className={`w-full px-4 py-3 rounded-xl border bg-[#070B19]/60 text-sm text-white placeholder-gray-600 focus:outline-none transition ${errClass('durationValue')}`}
              />
            ...
            <select
              ...
              className="w-full px-4 py-3 rounded-xl border border-white/5 bg-[#070B19]/60 text-sm text-gray-300 focus:outline-none focus:border-emerald-500/40 transition"
            >
