...
export default function CompanyAboutBlock({ biography, tagline, website, location }) {
  return (
    <div className="rounded-2xl border border-line bg-raised p-5 sm:p-6 shadow-xl relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        {location && (
          <div className="mt-4 pt-4 border-t border-line flex items-center gap-2 text-[11px] text-subtle">
