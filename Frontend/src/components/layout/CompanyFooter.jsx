    ...
    <footer className="mt-16 border-t border-line bg-raised">
      <div className="mx-auto flex max-w-7xl flex-col gap-4 px-4 py-8 sm:px-6 md:flex-row md:items-center md:justify-between lg:px-8">
        ...
        <nav className="flex flex-wrap gap-x-5 gap-y-2 text-xs text-subtle">
          <Link to="/company/home" className="hover:text-accent">Home</Link>
          <Link to="/company/dashboard" className="hover:text-accent">Dashboard</Link>
          <Link to="/company/internships" className="hover:text-accent">Internships</Link>
          <Link to="/company/search" className="hover:text-accent">Search</Link>
