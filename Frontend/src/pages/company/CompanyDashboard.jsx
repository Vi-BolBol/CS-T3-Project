    ...
    <div className="min-h-screen bg-surface text-content flex flex-col justify-between selection:bg-accent selection:text-[#070B19]">
      ...
      <main className="flex-1 mx-auto w-full max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        {loading && jobs.length === 0 ? (
          <div className="rounded-2xl border border-white/5 bg-[#111B34]/40 p-10 text-center text-sm text-subtle">
          ...
          <div className="rounded-2xl border border-rose-500/20 bg-rose-500/5 p-10 text-center">
            ...
            <button
              ...
              className="mt-4 px-4 py-2 rounded-xl text-xs font-bold bg-accent text-[#070B19] hover:bg-accent transition"
            >
              Try Again
            </button>
          </div>
        ) : jobs.length === 0 ? (
          <div className="rounded-2xl border border-dashed border-white/10 bg-raised/[0.01] p-12 text-center">
