...
export default function Button({ children, variant = 'primary', className = '', ...props }) {
  ...
  const variants = {
    primary: 'bg-accent hover:bg-accent text-accent-ink shadow-lg shadow-accent/5',
    secondary: 'border border-line bg-raised/5 text-subtle hover:bg-raised/10 hover:text-content',
