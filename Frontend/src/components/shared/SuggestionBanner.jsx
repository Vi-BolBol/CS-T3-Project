...
function SuggestionBanner() {
  ...
  return (
    <div className="bg-emerald-400/10 border border-emerald-400/30 rounded-xl px-5 py-4 mb-6 flex items-start justify-between gap-4">
      <div className="flex items-start gap-3">
        <svg className="w-5 h-5 text-emerald-300 shrink-0 mt-0.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5}>
        ...
        <div>
          ...
          <p className="text-sm text-slate-200 mt-1">{activeSuggestion.note}</p>
        </div>
      </div>
      <button
