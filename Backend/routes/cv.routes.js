...
router.post("/", protect, authorize("student"), enforceStatus, saveCv);
...
router.post("/generate-photo", protect, enforceStatus, generatePhoto);
router.post("/score", protect, enforceStatus, scoreCv);
router.post("/parse-upload", protect, enforceStatus, parseUploadedCv);
